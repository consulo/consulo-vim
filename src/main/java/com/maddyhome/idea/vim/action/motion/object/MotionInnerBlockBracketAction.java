...
/**
 */
public class MotionInnerBlockBracketAction extends TextObjectAction {
  public MotionInnerBlockBracketAction() {
    super(new MotionInnerBlockBracketAction.Handler());
  }
