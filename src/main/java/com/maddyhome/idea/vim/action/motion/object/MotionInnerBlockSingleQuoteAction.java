...
public class MotionInnerBlockSingleQuoteAction extends TextObjectAction {
  public MotionInnerBlockSingleQuoteAction() {
    super(new MotionInnerBlockSingleQuoteAction.Handler());
  }
