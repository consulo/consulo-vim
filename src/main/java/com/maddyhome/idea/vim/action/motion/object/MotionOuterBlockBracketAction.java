...
/**
 */
public class MotionOuterBlockBracketAction extends TextObjectAction {
  public MotionOuterBlockBracketAction() {
    super(new MotionOuterBlockBracketAction.Handler());
  }
