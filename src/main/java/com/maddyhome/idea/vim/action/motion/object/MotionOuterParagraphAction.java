...
/**
 */
public class MotionOuterParagraphAction extends TextObjectAction {
  public MotionOuterParagraphAction() {
    super(new MotionOuterParagraphAction.Handler());
  }
  ...
  private static class Handler extends TextObjectActionHandler {
    public TextRange getRange(@NotNull Editor editor, DataContext context, int count, int rawCount, Argument argument) {
      return VimPlugin.getMotion().getParagraphRange(editor, count, true);
    }
  }
}
